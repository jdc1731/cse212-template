...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found:  Line 37 Assert.AreEqual failed.Expected:<Bob>. Actual:<Sue>.
    ...
    // Defect(s) Found:  Line 65 Assert.AreEqual failed. Expected:<Bob>. Actual:<Sue>.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Line 107 Assert.AreEqual failed. Expected:<Bob>. Actual:<Sue>. 
    ...
    // Defect(s) Found: Line 135 Assert.AreEqual failed. Expected:<Tim>. Actual:<Sue>.
